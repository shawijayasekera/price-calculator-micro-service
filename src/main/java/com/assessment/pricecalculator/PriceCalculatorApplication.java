package com.assessment.pricecalculator;
...
public class PriceCalculatorApplication {
	...
	private ApiInfo apiDetails() {
		return new ApiInfo("Product Price Calculator API", "APIs for calculate product prices", "1.0", "",
				new Contact("Shashika Wijayasekera", "", "shashika.wijayasekera@hotmail.com"), "", "",
